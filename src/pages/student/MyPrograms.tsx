...
export default function MyPrograms() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-[var(--fg)]">Programlarım</h1>
        <p className="text-[var(--fg-muted)] mt-2">Kayıtlı olduğunuz tüm programlar</p>
      </div>
      ...
      {enrollments.length === 0 ? (
        <Card className="border-[var(--border)] bg-[var(--bg-card)]">
          <CardContent className="py-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-[var(--fg)] mb-2">Henüz programa kayıtlı değilsiniz</h3>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {enrollments.map((enrollment) => (
            <Card key={enrollment.id} className="border-[var(--border)] bg-[var(--bg-card)] overflow-hidden hover:shadow-lg transition-shadow">
              <div className="relative h-48">
                ...
                <div className="absolute top-4 right-4">
                  <Badge className={
                    enrollment.status === 'active' ? 'bg-[var(--color-primary)]' :
              ...
              <CardHeader>
                <CardTitle className="text-[var(--fg)]">{enrollment.programs.title}</CardTitle>
                <CardDescription className="text-[var(--fg-muted)]">{enrollment.programs.description}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-[var(--fg)]">{enrollment.progress || 0}%</span>
                  </div>
