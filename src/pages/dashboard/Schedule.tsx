  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Yaklaşan ve geçmiş dersleriniz</p>
      </div>

      {/* Upcoming Sessions */}
      <div>
        <h2 className="text-2xl font-bold text-foreground mb-4">Yaklaşan Dersler</h2>
      ...
      {/* Past Sessions */}
      <div>
        <h2 className="text-2xl font-bold text-foreground mb-4">Geçmiş Dersler</h2>
        <div className="space-y-4">
